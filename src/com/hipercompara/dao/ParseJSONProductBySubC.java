...
/**
 * Clase que baja del servidor web el listado de productos 
 * perteneciente a una subcategoria elegida por el usuario
 * @author Javier
 *
 */
public class ParseJSONProductBySubC extends AsyncTask<Integer, Integer, Boolean> {
ArrayList<Product> product=null;
	
	public ParseJSONProductBySubC() {
		
	}

/**
 * Funcion que debes pasar como unico parametro el id de la subcategoria 
 * de la que quieres obtener todos sus productos
 * 
 */
	...
	protected Boolean doInBackground(Integer... params) {
        ...
        HttpGet httpGet = new HttpGet("http://hipercompara.shenko.me/json/product_by_sub.php?sub_id="+params[0]);
